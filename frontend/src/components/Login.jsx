      ...
      <div className="auth-form-section">
        <div className="auth-form-container">
          <div className="auth-welcome">
            <h1>Welcome back!</h1>
            <p>Simplify your workflow and boost your productivity with <strong>NearServe</strong>. Get started for free.</p>
          </div>
          ...
          <div className="auth-footer">
            <p>Not a member? <button onClick={onSwitchToRegister} className="link-btn">Register now</button></p>
          </div>
        </div>
      </div>
